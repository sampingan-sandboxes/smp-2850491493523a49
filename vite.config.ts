...
const config = {
  ...
  test: {
    ...
    coverage: {
      provider: 'v8',
      // Coverage is measured against the code you write in the playbook module. Acceptance
      // step definitions and the provided msw simulator are excluded.
      include: ['src/components/playbook/**'],
      exclude: ['src/components/playbook/mocks.ts'],
